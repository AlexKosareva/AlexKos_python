...
# Создаем экземпляр калькулятора (хотя внутри тестов мы создаем новые для чистоты)
...
def test_div_by_zero():
    """Проверка деления на ноль: ожидаем исключение ArithmeticError"""
    calculator = Calculator()
    # Код, вызывающий ошибку, должен быть ВНУТРИ блока with с отступом
